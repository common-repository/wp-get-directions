...
function blz_get_directions_sc($atts) {
    ...
    if (empty($lat) || empty($lon)) {
        ...
        $output = '<form action="//maps.google.com/maps" method="get" target="_blank" id="blz-get-directions">
      ...
      <a class="use-my-location" style="margin-left:10px" href="//maps.google.com/maps?saddr=My%20Location&daddr=' . $lat . '%2C+' . $lon . '" target="_blank" title="' . __('Use my location', 'wp-get-directions') . '"><i class="fa fa-location-arrow"></i> ' . __('Use my location', 'wp-get-directions') . '</a>
